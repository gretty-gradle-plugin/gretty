...
class SSODigestAuthenticator extends DigestAuthenticator {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SSODigestAuthenticator.class);
    ...
    public UserIdentity login(String username, Object password, Request request, Response response)
    {
        ...
        if (user!=null)
        {
            ...
            SessionAuthentication cached=new SessionAuthentication(Authenticator.DIGEST_AUTH,user,password);
