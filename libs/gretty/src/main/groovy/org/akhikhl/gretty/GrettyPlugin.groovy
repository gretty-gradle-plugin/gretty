...
class GrettyPlugin implements Plugin<Project> {
  ...
  void apply(final Project project) {
    ...
    project.ext {
      ...
      if(!has('jetty12Version'))
        jetty12Version = Externalized.getString('jetty12Version')
      if(!has('jetty12ServletApiVersion'))
        jetty12ServletApiVersion = Externalized.getString('jetty12ServletApiVersion')
      ...
      if(!has('tomcat11Version'))
        tomcat11Version = Externalized.getString('tomcat11Version')
      if(!has('tomcat11ServletApiVersion'))
        tomcat11ServletApiVersion = Externalized.getString('tomcat11ServletApiVersion')
      if(!has('asmVersion'))
