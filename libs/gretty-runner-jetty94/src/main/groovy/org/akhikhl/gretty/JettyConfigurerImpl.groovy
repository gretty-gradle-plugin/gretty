...
class JettyConfigurerImpl implements JettyConfigurer {
  ...
  def beforeStart(boolean isDebug) {
    setLevel( 'org.akhikhl.gretty', isDebug ? AbstractLogger.LEVEL_DEBUG : AbstractLogger.LEVEL_INFO)
    setLevel('org.eclipse.jetty', AbstractLogger.LEVEL_WARN)
    setLevel('org.eclipse.jetty.annotations.AnnotationConfiguration', AbstractLogger.LEVEL_OFF)
    setLevel('org.eclipse.jetty.annotations.AnnotationParser', AbstractLogger.LEVEL_OFF)
    setLevel('org.eclipse.jetty.util.component.AbstractLifeCycle', AbstractLogger.LEVEL_OFF)
  }
